...
def record_to_file(filename="E:\\Django\\E-Trading\\ETrading\\text.wav",FORMAT = pyaudio.paInt16, CHANNELS = 1, RATE = 8000,
...
def convert_speech2text(filename="E:\\Django\\E-Trading\\ETrading\\text.wav", file="res.txt"):
...
def main(res='res.txt'):
	...
	filename="E:\\Django\\E-Trading\\ETrading\\text.wav"
	file=res
